...
(function () {
  ...
  /* Journey strip: you-are-here (leader track of 6, practitioner track of 8) */
  ...
  if (crumb && mastheadWrap) {
    ...
    var m = mx || crumb.textContent.match(/Practitioner session (\d+) of 8/);
    if (m) {
      var current = parseInt(m[1], 10);
      var pages = mx
        ? ["a1-scope.html", "a2-principles-bases.html", "a3-rights.html",
           "a4-controller-processor.html", "a5-breach-penalties.html", "a6-transfers.html"]
        : ["b1-applicability.html", "b2-lawful-basis.html", "b3-privacy-notices.html",
           "b4-dsar.html", "b5-records-dpia.html", "b6-transfers-practice.html",
           "b7-breach-response.html", "b8-gdpr-program.html"];
      var journey = document.createElement("div");
      journey.className = "journey";
      var jl = document.createElement("span");
      jl.className = "jlabel";
      jl.textContent = mx ? "Leader track" : "Practitioner track";
